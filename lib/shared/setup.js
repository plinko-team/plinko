...
function createWalls(stage) {
  var leftWall = new _Wall.VerticalWall({ x: 0, y: _canvas.CANVAS_HEIGHT / 2 });
  var rightWall = new _Wall.VerticalWall({ x: _canvas.CANVAS_WIDTH, y: _canvas.CANVAS_HEIGHT / 2 });
