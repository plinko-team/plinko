  ...
  _createClass(Chip, [{
    ...
    value: function registerUpdateListener(engine) {
      ...
      _matterJs.Events.on(engine, 'afterUpdate', function () {
        _this.sprite.position.x = _this.body.position.x;
        _this.sprite.position.y = _this.body.position.y;
        _this.sprite.rotation = _this.body.angle;
        _this.x = _this.body.position.x;
        _this.y = _this.body.position.y;
      });
    }
  }, {
    key: 'createSprite',
